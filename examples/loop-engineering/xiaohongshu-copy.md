...
📌 这篇 Loop Engineering 主要讲：
✅ 把 Prompt 工作升级成可重复的工程循环
✅ 用 Discovery、Handoff、Verification、Persistence、Scheduling 组织 Agent 工作流
📈 论文的关键提醒：生成越来越便宜，判断和验证反而更稀缺
⚠️ 循环不是越自动越好，仍然要保留人的检查和否决权
